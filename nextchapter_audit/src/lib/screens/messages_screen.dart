                        ...
                        ? Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Start browsing profiles and say hello!',
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ConversationTile(
                                ...
                                onDelete: () => provider.deleteConversation(convo.id),
                              );
                            },
                          ),
              ),
...
class _TabButton extends StatelessWidget {
  ...
  const _TabButton({required this.label, required this.isSelected, required this.onTap, required this.colors, required this.text});
